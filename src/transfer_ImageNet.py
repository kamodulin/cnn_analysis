...
if __name__ == "__main__":
    SAVE_PATH = "/home/kaa716/data/model-weights/alexnet-imagenet-transfer-from-cifar10"
    ...
    net.set_weights("/home/kaa716/data/model-weights/alexnet-cifar10-train/epoch59.pth")

...
def train_one_epoch(model, epoch, batch_size, criterion, optimizer, lr_scheduler, data_loader, device):
    ...
    for i, (images, labels) in enumerate(data_loader):
        ...
        _, pred = torch.topk(probabilities, 1) # TOP 1
    ...
    torch.save({
        ...
        'epoch': epoch
    }, f"/home/kaa716/data/model-weights/alexnet-cifar10-train/epoch{epoch}.pth")
...
def train(model, epochs, batch_size, criterion, optimizer, lr_scheduler, num_workers, device):
    os.mkdir("/home/kaa716/data/model-weights/alexnet-cifar10-train")
    ...
    torch.save({
        ...
        'lr_scheduler': lr_scheduler.state_dict(),
        'epoch': 0
    }, f"/home/kaa716/data/model-weights/alexnet-cifar10-train/epoch0.pth")
